...
const Admin = () => {
    ...
    const [jollaDetails, setJollaDetails] = useState({ title: "", description: "", image: "", author: "", price: "" });
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            ...
            setImage(image);
            setJollaDetails({ ...jollaDetails, image: url });
        } catch (err) {
            console.log(err);
        }
    }
                        ...
                        <div className="form-fields">
                            <div className="title-form">
                                ...
                                <p><input
                                    ...
                                    onChange={(e) => setJollaDetails({ ...jollaDetails, title: e.target.value })}
                                    required
                                /></p>
                            </div>
                            <div className="description-form">
                                ...
                                <p><textarea
                                    ...
                                    onChange={(e) => setJollaDetails({ ...jollaDetails, description: e.target.value })}
                                    required
                                /></p>
                            </div>
                            <div className="author-form">
                                ...
                                <p><input
                                    ...
                                    onChange={(e) => setJollaDetails({ ...jollaDetails, author: e.target.value })}
                                    required
                                /></p>
                            </div>
                            <div className="price-form">
                                <p><label htmlFor="price">Price ($)</label>
                                    <input
                                        ...
                                        onChange={(e) => setJollaDetails({ ...jollaDetails, price: e.target.value })}
                                        required
                                    /></p>
                            </div>
                            <div className="featured-form">
                                <p><label>Featured?</label>
                                    <input type="checkbox"
                                        ...
                                        checked={jollaDetails.featured}
                                        onChange={() => setJollaDetails({ ...jollaDetails, featured: !jollaDetails.featured })}
                                    />
                                </p>
                            </div>
